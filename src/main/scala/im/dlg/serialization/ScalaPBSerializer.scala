...
object ScalaPBSerializer {
  ...
  def fromMessage(message: SerializedMessage): GeneratedMessage = {
  ...
  def fromBinary(bytes: Array[Byte]): GeneratedMessage =
...
class ScalaPBSerializerObsolete extends Serializer {
  ...
  override def fromBinary(bytes: Array[Byte],
    ...
    ScalaPBSerializer.fromBinary(bytes).asInstanceOf[AnyRef]
...
class ScalaPBSerializer extends SerializerWithStringManifest {
  ...
  override def toBinary(o: AnyRef): Array[Byte] =
    o match {
      ...
      case _ ⇒
        throw new IllegalArgumentException(
          "Only GeneratedMessage is supported")
    }
}
